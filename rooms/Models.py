...
class Star(db.Model):
    ...
    __table_args__ = (db.UniqueConstraint('user_id', 'room_id', name='unique_user_room_star'),)
...
class Member(db.Model):
    ...
    __table_args__ = (db.UniqueConstraint('user_id', 'room_id', name='unique_user_room_membership'),)
